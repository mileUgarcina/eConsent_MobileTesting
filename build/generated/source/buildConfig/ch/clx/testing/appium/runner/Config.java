...
public class Config {
  ...
  public static class Android {
    ...
    public static final String SauceLabsName = "eConsent - Participant - QA";
    public static final String OSVersion = "13.0";
  ...
  public static class iOS {
    ...
    public static final String OSVersionSimulator = "1516";
  public static final class Clinical {
    public static final String Username = "mobile.automation@florencehc.com";
    public static final String Password = "Password123*";
   public static final String FirstName = "Active";
