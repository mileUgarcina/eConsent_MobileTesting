...
//        TODO waiting for TC Data
    ...
    public void participant_Auth_Mobile_Reset_password_Input_fields_respond_to_invalid_data(){
    ...
    @Test(groups= { "Android", "iOS"},
            ...
            retryAnalyzer = TcRetry.class)
    public void participant_Auth_Mobile_Reset_password_Input_fields_respond_to_valid_data(){
        testCaseName = new Object(){}.getClass().getEnclosingMethod().getName();
        tcId = new Object(){}.getClass().getEnclosingMethod().getAnnotation(TcID.class).tcId();
    ...
    @Test(groups= { "Android", "iOS"},
            ...
            retryAnalyzer = TcRetry.class)
    public void participant_Auth_Mobile_Reset_password_Input_fields_respond_to_clear_data(){
        testCaseName = new Object(){}.getClass().getEnclosingMethod().getName();
        tcId = new Object(){}.getClass().getEnclosingMethod().getAnnotation(TcID.class).tcId();

        rypp.clear_emailInputField();
        rypp.insert_emailInputField("a");
        rypp.clear_emailInputField();
        rypp.assert_emailFieldColor(inputFieldBorderColorRed, "Red");
    ...
    @Test(groups= { "Android", "iOS"},
            ...
            retryAnalyzer = TcRetry.class)
    public void participant_Auth_Mobile_Reset_password_Reset_password_with_invalid_email(){
        testCaseName = new Object(){}.getClass().getEnclosingMethod().getName();
        tcId = new Object(){}.getClass().getEnclosingMethod().getAnnotation(TcID.class).tcId();

        rypp.clear_emailInputField();
        rypp.insert_emailInputField(email_valid);
        rypp.insert_passwordInputField(password_valid);
        rypp.insert_rePasswordInputField(password_valid);
    ...
    @Test(groups= { "Android", "iOS"},
            ...
            retryAnalyzer = TcRetry.class)
    public void participant_Auth_Mobile_Reset_password_Reset_password_with_an_old_password(String user) {
        testCaseName = new Object(){}.getClass().getEnclosingMethod().getName();
        tcId = new Object(){}.getClass().getEnclosingMethod().getAnnotation(TcID.class).tcId();
...
//        TODO waiting for TC Data
    ...
    @Test(groups= { "Android", "iOS"},
            ...
            retryAnalyzer = TcRetry.class)
    public void participant_Auth_Mobile_Reset_password_action(){
        testCaseName = new Object(){}.getClass().getEnclosingMethod().getName();
        tcId = new Object(){}.getClass().getEnclosingMethod().getAnnotation(TcID.class).tcId();
