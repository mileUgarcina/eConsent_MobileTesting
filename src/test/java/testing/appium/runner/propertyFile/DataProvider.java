...
//        SignIn Page
        ...
        public static String errorMsg_unactivatedUser = PropertyReader.TcDataReader.get("errorMsg_unactivatedUser");
        public static String errorMsg_incorrectInput = PropertyReader.TcDataReader.get("errorMsg_incorrectInput");
        public static String errorMsg_emailField_incorrect = PropertyReader.TcDataReader.get("errorMsg_emailField_Incorrect");
        public static String errorMsg_emailField_Required = PropertyReader.TcDataReader.get("errorMsg_emailField_Required");
        public static String errorMsg_IncorrectPassword = PropertyReader.TcDataReader.get("errorMsg_IncorrectPassword");
        public static String errorMsg_lockedTemporarily = PropertyReader.TcDataReader.get("errorMsg_lockedTemporarily");
        public static String errorMsg_lockedPermanently = PropertyReader.TcDataReader.get("errorMsg_lockedPermanently");
        public static String errorMsg_recoverAccount = PropertyReader.TcDataReader.get("errorMsg_recoverAccount");
        public static String inputFieldBorderColorRed = PropertyReader.TcDataReader.get("inputFieldBorderColorRed");
        public static String inputFieldBorderColorRedV2 = PropertyReader.TcDataReader.get("inputFieldBorderColorRedV2");
        public static String inputFieldBorderColorBlue = PropertyReader.TcDataReader.get("inputFieldBorderColorBlue");
        public static String nativeBrowserDialog_backBtn = PropertyReader.TcDataReader.get("nativeBrowserDialog_backBtn");
        public static String nativeBrowserDialog_reload = PropertyReader.TcDataReader.get("nativeBrowserDialog_reload");
        public static String toastMessage_successfully = PropertyReader.TcDataReader.get("toastMessage_successfully");
        public static String errorMsg_wrong = PropertyReader.TcDataReader.get("errorMsg_wrong");
        public static String errorMsg_Token = PropertyReader.TcDataReader.get("errorMsg_Token");
        public static String legalNameTooltipMsg = PropertyReader.TcDataReader.get("legalNameTooltipMsg");
        public static String emailTooltipMsg = PropertyReader.TcDataReader.get("emailTooltipMsg");
        public static String errorMsg_mandatoryField_Incorrect = PropertyReader.TcDataReader.get("errorMsg_mandatoryField_Incorrect");
        public static String errorMsg_passwordField_Incorrect = PropertyReader.TcDataReader.get("errorMsg_passwordField_Incorrect");
        public static String errorMsg_rePasswordField_Incorrect = PropertyReader.TcDataReader.get("errorMsg_rePasswordField_Incorrect");
        public static String signInBtnTooltipMsg = PropertyReader.TcDataReader.get("signInBtnTooltipMsg");
        public static String toastMessage_email_successfully = PropertyReader.TcDataReader.get("toastMessage_email_successfully");
        public static String toastMessage_password_successfully = PropertyReader.TcDataReader.get("toastMessage_password_successfully");
        public static String toastMessage_email_error = PropertyReader.TcDataReader.get("toastMessage_email_error");
        public static String toastMessage_old_password_error = PropertyReader.TcDataReader.get("toastMessage_old_password_error");
        public static String errorMsg_rePassword = PropertyReader.TcDataReader.get("errorMsg_rePassword");
        public static String declineStudyPopUpMsg = PropertyReader.TcDataReader.get("declineStudyPopUpMsg");
        public static String inactivityWarningTitle = PropertyReader.TcDataReader.get("inactivityWarningTitle");
        public static String inactivityWarningBody = PropertyReader.TcDataReader.get("inactivityWarningBody");
